...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Entity\RefreshTokenRepository")
 */
class RefreshToken extends BaseRefreshToken
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Webkul\UVDesk\ApiBundle\Entity\Client", inversedBy="refreshTokens")
     */
    protected $client;
